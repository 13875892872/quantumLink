<template>
  <login-layout v-if="!loading" v-loading="loading || sendLoading">
    <LoginContainer
      ...
      "
    >
      <h2 class="mb-24">{{ $t('views.customerLogin.resetPassword') }}</h2>
      <el-form
        ...
        <div class="mb-24">
          <el-form-item prop="password">
            <el-input
              ...
              :placeholder="$t('views.customerLogin.userForm.form.password.placeholder')"
              show-password
            >
            </el-input>
          </el-form-item>
        ...
        <div class="mb-24">
          <el-form-item prop="re_password">
            <el-input
              ...
              :placeholder="$t('views.customerLogin.userForm.form.re_password.placeholder')"
              show-password
            >
            </el-input>
          </el-form-item>
    ...
    },
    {
      validator: (rule, value, callback) => {
        if (resetPasswordForm.value.password != resetPasswordForm.value.re_password) {
          callback(new Error(t('views.customerLogin.userForm.form.re_password.validatorMessage')))
        } else {
          callback()
        }
      },
